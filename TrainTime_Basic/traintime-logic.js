...
// I have replaced original API key wiht the one associate to my account
...
// Initialize Firebase
var config = {
  apiKey: "AIzaSyBuroOaRDZWO3s5GX03aj9QVcMUrznfAhE",
...
$("#add-train-btn").on("click", function(event) {
  ...
  // Grabs user input
  //Grab input from local user file
  ...
  //push and store new data into database
  //Without push, inforamtion in data will be replaced by new input.
...
//This also behaved like localStorage that user can retrieve data from database
trainData.ref().on("child_added", function(childSnapshot, prevChildKey) {
  console.log(childSnapshot.val());

  // Store everything into a variable.to database
  //Any data stored here will be svaed 
  var tName = childSnapshot.val().name;
  var tDestination = childSnapshot.val().destination;
  var tFrequency = childSnapshot.val().frequency;
  var tFirstTrain = childSnapshot.val().firstTrain;
//From here, it uses Moment.js to to retrieve real time.
